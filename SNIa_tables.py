...
def make_LeungNomoto_tables():
    ...
    num_species = 9
    # Taken from Leung & Nomoto (2018) table 12
    yields = np.array([0, 0, 5.2e-2, 9.56e-10, 1.85e-1, 2.73e-3, 4.26e-3, 1.55e-1, 6.68e-1])
    metal_mass_lost = 1.37 #Msun

    # Write data to HDF5
    with h5py.File('./data/SNIa_W7LeungNomoto2018.hdf5', 'w') as data_file:
        Header = data_file.create_group('Header')
